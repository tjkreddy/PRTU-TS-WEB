    ...
    return (
        <>
            ...
            <div className="md:hidden fixed bottom-0 left-0 right-0 z-50">
                <div className="bg-white border-t border-gray-200 shadow-lg backdrop-blur-md bg-white/95">
                        ...
                        {navItems.map((item) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`relative flex flex-col items-center justify-center py-3 px-1 transition-all duration-200 ${
                                        isActive
                                            ? 'text-blue-600'
